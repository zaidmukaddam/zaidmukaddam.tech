...
const ItemProject = ({ data }: ItemProjectProps) => {
  ...
  return (
    <div className='sm:min-h-[320px] pb-6 sm:pb-2 cursor-pointer flex flex-col h-full rounded-lg border dark:border-[#383838] border-[#525252]'>
      <div className='relative flex w-full items-stretch xl:h-[74%] rounded-t'>
        <Image
