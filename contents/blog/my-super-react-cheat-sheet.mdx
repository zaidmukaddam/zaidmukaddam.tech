---
title: My super React Cheat Sheet!
description: The best React Cheat Sheet ever!
publishedAt: '2022-02-10'
---

# Getting started with React

React is great but can be complex for beginners. Whenever I need to do even the smallest thing, I have to check out the React documentation, a tutorial, or post a question on a forum.

That's why I decided to do this memory aid and given that my memory is not that good I thought why not make a monstrous memory aid with all the basic concepts I know about React.
...
Use className instead of class Also all attribute name need to be camelCase
...
(src/App.js) Import the CSS file
...
useEffect will run only if state is in the Dependency List. If the list is empty [] the useEffect will only run on initial render.
...
Inline Logical && Operator. Display only if first expression is truthy truthy = Not : 0, "", null, undefined, and NaN
...
That's it! You can learn more about React Hooks in the [React Hooks documentation](https://reactjs.org/docs/hooks-intro.html).
