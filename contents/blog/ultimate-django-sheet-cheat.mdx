---
title: Ultimate Django Cheat Sheet!
description: Django memory aid - Everything you need to remember to create a Python Django Web Application
...
Create superuser for authenticiation/admin panel
